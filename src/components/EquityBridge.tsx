...
export function EquityBridge({ close, transactions, positions, accounts, scope, chart = false }: {
  ...
  return <>
    ...
    {step && <section id="equity-bridge-detail" aria-label={`${step.label} breakdown`} className="mt-4 rounded-xl border border-border-soft p-4">
      ...
      {selected === 4 && <p className="mt-3 text-sm text-muted">This value is generated by a placeholder market-movement formula, not historical prices or transactions. A ticker-level breakdown is unavailable; this is not measured investment performance.</p>}
