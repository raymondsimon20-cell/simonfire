...
export type SharedPreferences = Pick<AppData, 'statementTransactions' | 'bucketOverrides' | 'tagRules' | 'symbolRules' | 'targetAlloc' | 'keepList' | 'soldSymbols' | 'incomePlan' | 'spendingExclusions' | 'realizedPlOverrides' | 'csvPositionAuthority' | 'csvTransactionAuthority' | 'importHistory' | 'freshnessThresholds' | 'savedTransactionViews' | 'transactionOverrides' | 'accountOpenMonths'> & { historicalBalances?: HistoricalBalance[] }
