...
export type SharedPreferences = Pick<AppData, 'bucketOverrides' | 'tagRules' | 'symbolRules' | 'targetAlloc' | 'keepList' | 'soldSymbols' | 'incomePlan' | 'spendingExclusions' | 'realizedPlOverrides'>
