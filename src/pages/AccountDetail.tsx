...
function BalanceHistoryTab({
  ...
  const twr = useMemo(() => {
    const recorded = statementTwr(statementHistory(data.historicalBalances ?? [], data.accounts, account.id, data.balanceSnapshots, data.accountOpenMonths), '', flowContext(txns))
